...
export class UserRepository {
  ...
  public async createUser(data: CreateUserData): Promise<SafeUser> {
    try {
      ...
      return UserMapper.excludePasswordFromUser(user);
    } catch (error) {
  ...
  private async findUserByCriteria(
    ...
    try {
      ...
      return includePassword ? user : UserMapper.excludePasswordFromUser(user);
    } catch (error) {
      const identifier = this.extractQueryIdentifier(criteria);
  ...
  public async updateUser(id: string, data: UpdateUserData): Promise<SafeUser> {
    try {
      ...
      // Remove password before returning
      return UserMapper.excludePasswordFromUser(updatedUser);
    } catch (error) {
  ...
  public async findManyUsersByOptions(
    ...
    try {
      ...
      return {
        data: UserMapper.excludePasswordFromUsers(users),
        pagination: {
          total: totalCount,
          skip,
          take,
